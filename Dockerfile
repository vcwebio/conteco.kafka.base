...
COPY ./conteco/configs/etc/kafka/log4j.properties /etc/kafka/log4j.properties
COPY ./conteco/configs/etc/kafka/tools-log4j.properties /etc/kafka/tools-log4j.properties
